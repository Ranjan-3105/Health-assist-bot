...
import { Thermometer, Wind, Baby, Ban as Bandage } from 'lucide-react';
 ...
 interface QuickAcessChipsProps {
    selectedLanguage: string;
  }

 const urgentHelp: Record<string, string> = {
  English: "Immediate Help",
  Hindi: "तुरंत सहायता",
  Odia: "ତୁରନ୍ତ ସହାୟତା",
  Bengali: "তাৎক্ষণিক সাহায্য",
};
...
const QuickAccessChips: React.FC<QuickAcessChipsProps> = ({ selectedLanguage })=> {
